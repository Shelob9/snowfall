...
function snowfall_widgets_init() {
   ...
   register_sidebar( array(
      'name'            => esc_html__( 'Right Sidebar', 'snowfall' ),
      'id'              => 'snowfall_right_sidebar',
      'description'     => __( 'Shows widgets at Right side.', 'snowfall' ),
   ...
   register_sidebar( array(
      'name'            => esc_html__( 'Left Sidebar', 'snowfall' ),
      'id'              => 'snowfall_left_sidebar',
      'description'     => __( 'Shows widgets at Left side.', 'snowfall' ),
      'before_widget'   => '<aside id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</aside>',
      'before_title'    => '<h4 class="widget-title"><span>',
      'after_title'     => '</span></h4>'
   ...
   register_sidebar( array(
      'name'            => esc_html__( 'Front Page Sidebar', 'snowfall' ),
      'id'              => 'snowfall_front_page_section',
      'description'     => __( 'Show widgets at Front Page Content Section', 'snowfall' ),
   ...
   register_sidebar( array(
      'name'            => esc_html__( 'Error 404 Page Sidebar', 'snowfall' ),
      'id'              => 'snowfall_error_404_page_sidebar',
      'description'     => __( 'Shows widgets on Error 404 page.', 'snowfall' ),
      'before_widget'   => '<aside id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</aside>',
   ...
   register_sidebar( array(
      'name'            => esc_html__( 'Footer Sidebar One', 'snowfall' ),
      'id'              => 'snowfall_footer_sidebar_one',
      'description'     => __( 'Shows widgets on footer.', 'snowfall' ),
      'before_widget'   => '<aside id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</aside>',
      'before_title'    => '<h4 class="widget-title"><span>',
      'after_title'     => '</span></h4>'
   ...
   register_sidebar( array(
      'name'            => esc_html__( 'Footer Sidebar Two', 'snowfall' ),
      'id'              => 'snowfall_footer_sidebar_two',
      'description'     => __( 'Shows widgets on footer.', 'snowfall' ),
      'before_widget'   => '<aside id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</aside>',
      'before_title'    => '<h4 class="widget-title"><span>',
   ...
   register_sidebar( array(
      'name'            => esc_html__( 'Footer Sidebar Three', 'snowfall' ),
      'id'              => 'snowfall_footer_sidebar_three',
      'description'     => __( 'Shows widgets on footer.', 'snowfall' ),
      'before_widget'   => '<aside id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</aside>',
      'before_title'    => '<h4 class="widget-title"><span>',
   ...
   register_widget( "snowfall_about_us_widget" );
   register_widget( "snowfall_service_widget" );
   register_widget( "snowfall_call_to_action_widget" );
   register_widget( "snowfall_portfolio_widget" );
   register_widget( "snowfall_featured_posts_widget" );
   register_widget( "snowfall_our_team_widget" );
   register_widget( "snowfall_contact_widget" );
}
 ...
 * About us section.
 */
class snowfall_about_us_widget extends WP_Widget {
   function __construct() {
      $widget_ops = array( 'classname' => 'widget_about_block', 'description' => __( 'Show your about page.', 'snowfall' ) );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::__construct( false, $name = __( 'TG: About Widget', 'snowfall' ), $widget_ops, $control_ops);
   }
   ...
   function form( $instance ) {
      ...
      ?>
      <p><?php _e( 'Note: Enter the About Section ID and use same for Menu item. Only used for One Page Menu.', 'snowfall' ); ?></p>

      <p>
         <label for="<?php echo $this->get_field_id( 'about_menu_id' ); ?>"><?php _e( 'About Section ID:', 'snowfall' ); ?></label>
      ...
      <p>
         <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'snowfall' ); ?></label>
         <input id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" />
      </p>

      <?php _e( 'Description','snowfall' ); ?>
      <textarea class="widefat" rows="5" cols="20" id="<?php echo $this->get_field_id( 'text' ); ?>" name="<?php echo $this->get_field_name( 'text' ); ?>"><?php echo $text; ?></textarea>

      <p><?php _e('Select a page to display Title, Excerpt and Featured image.', 'snowfall') ?></p>
      <label for="<?php echo $this->get_field_id( 'page_id' ); ?>"><?php _e( 'Page', 'snowfall' ); ?>:</label>
      <?php wp_dropdown_pages( array( 'show_option_none' =>' ','name' => $this->get_field_name( 'page_id' ), 'selected' => $instance[ 'page_id' ] ) ); ?>

      <p>
         <label for="<?php echo $this->get_field_id( 'button_text' ); ?>"><?php _e( 'Button Text:', 'snowfall' ); ?></label>
      ...
      <p>
         <label for="<?php echo $this->get_field_id( 'button_url' ); ?>"><?php _e( 'Button Redirect Link:', 'snowfall' ); ?></label>
      ...
      <p>
         <label for="<?php echo $this->get_field_id( 'button_icon' ); ?>"><?php _e( 'Button Icon Class:', 'snowfall' ); ?></label>
      ...
      <p>
         ...
         $link = sprintf( __( '<a href="%s" target="_blank">Refer here</a> For Icon Class', 'snowfall' ), esc_url( $url ) );
         echo $link;
         ?>
      </p>
   <?php }
                  ...
                  while( $the_query->have_posts() ):$the_query->the_post();
                     ...
                     if( has_post_thumbnail() ) { ?>
                        <div class="about-image tg-column-2">
                           <?php the_post_thumbnail( 'snowfall-featured-abt' ); ?>
                        </div>
                     <?php } ?>
                     ...
                     <div class="about-content tg-column-2">
                        ...
                        $output .= '<div class="about-btn"> <a href="'. get_permalink() . '">' . __( 'Read more', 'snowfall' ) . '</a>';
 ...
 */
class snowfall_service_widget extends WP_Widget {
   function __construct() {
      $widget_ops = array( 'classname' => 'widget_service_block', 'description' => __( 'Display some pages as services.', 'snowfall' ) );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::__construct( false, $name = __( 'TG: Service Widget', 'snowfall' ), $widget_ops, $control_ops);
   }
   ...
   function form( $instance ) {
      ...
      <p><?php _e( 'Note: Enter the Service Section ID and use same for Menu item. Only used for One Page Menu.', 'snowfall' ); ?></p>

      <p>
         <label for="<?php echo $this->get_field_id('service_menu_id'); ?>"><?php _e( 'Service Section ID:', 'snowfall' ); ?></label>
      ...
      <p>
         <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of pages to display:', 'snowfall' ); ?></label>
         <input id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo $this->get_field_name( 'number' ); ?>" type="text" value="<?php echo $number; ?>" size="3" />
      </p>

      <p><?php _e( 'Note: Create the pages and select Services Template to display Services pages.', 'snowfall' ); ?></p>
   <?php }
                     ...
                     <div class="tg-column-wrapper clearfix">
                        ...
                        <?php while( $get_featured_pages->have_posts() ):$get_featured_pages->the_post();
                           ...
                           <div class="tg-column-3 tg-column-bottom-margin">
                              <?php
                              $snowfall_icon = get_post_meta( $post->ID, 'snowfall_font_icon', true );
                              $snowfall_icon = isset( $snowfall_icon ) ? esc_attr( $snowfall_icon ) : '';

                              $icon_image_class = '';
                              if( !empty ( $snowfall_icon ) ) {
                                 $icon_image_class = 'service_icon_class';
                                 $services_top = '<i class="fa ' . esc_html( $snowfall_icon ) . '"></i>';
                              }
                              if( has_post_thumbnail() ) {
                                 $icon_image_class = 'service_image_class';
                                 $services_top = get_the_post_thumbnail( $post->ID, 'snowfall-services' );
                              }

                              if( has_post_thumbnail() || !empty ( $snowfall_icon ) ) { ?>
                              ...
                              <div class="service-desc-wrap">
                                 ...
                                 <a class="service-read-more" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"> <?php  _e( 'Read more', 'snowfall' ) ?><i class="fa fa-angle-double-right"> </i></a>
                              </div>
                           </div>
                           <?php $count++;
                        endwhile; ?>
 ...
 */
class snowfall_call_to_action_widget extends WP_Widget {
   function __construct() {
      $widget_ops = array( 'classname' => 'widget_call_to_action_block', 'description' => __( 'Use this widget to show the call to action section.', 'snowfall' ) );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::__construct( false, $name = __( 'TG: Call To Action Widget', 'snowfall' ), $widget_ops, $control_ops);
   }
   ...
   function form( $instance ) {
      ...
      ?>
      <p>
         <strong><?php _e( 'DESIGN SETTINGS :', 'snowfall' ); ?></strong><br />
         <label for="<?php echo $this->get_field_id( 'background_color' ); ?>"><?php _e( 'Background Color:', 'snowfall' ); ?></label><br />
      ...
      <p>
         <label for="<?php echo $this->get_field_id( 'background_image' ); ?>"> <?php _e( 'Image:', 'snowfall' ); ?> </label> <br />
      ...
      <strong><?php _e( 'OTHER SETTINGS :', 'snowfall' ); ?></strong><br />

      <?php _e( 'Call to Action Main Text','snowfall' ); ?>
      ...
      <?php _e( 'Call to Action Additional Text','snowfall' ); ?>
      ...
      <?php _e( 'Choose the layout','snowfall' ); ?>
      <p>
         <select id="<?php echo $this->get_field_id('select'); ?>" name="<?php echo $this->get_field_name('select'); ?>">
            <option value="cta-text-style-1" <?php if ( $select == 'cta-text-style-1' ) echo 'selected="selected"'; ?> ><?php _e( 'Layout One', 'snowfall' );?></option>
            <option value="cta-text-style-2" <?php if ( $select == 'cta-text-style-2' ) echo 'selected="selected"';?> ><?php _e( 'Layout Two', 'snowfall' );?></option>
         </select>
      </p>
   <?php
   }
 ...
 */
class snowfall_portfolio_widget extends WP_Widget {

   function __construct() {
      $widget_ops = array( 'classname' => 'widget_portfolio_block', 'description' => __( 'Display portfolio by using specific category', 'snowfall') );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::__construct( false,$name= __( 'TG: Portfolio', 'snowfall' ), $widget_ops);
   }
   ...
   function form( $instance ) {
      ...
      <p><?php _e( 'Note: Enter the Portfolio Section ID and use same for Menu item. Only used for One Page Menu.', 'snowfall' ); ?></p>

      <p>
         <label for="<?php echo $this->get_field_id( 'portfolio_menu_id' ); ?>"><?php _e( 'Portfolio Section ID:', 'snowfall' ); ?></label>
      ...
      <p>
         <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of posts to display:', 'snowfall' ); ?></label>
         <input id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo $this->get_field_name( 'number' ); ?>" type="text" value="<?php echo $number; ?>" size="3" />
      </p>

      <p><?php _e( 'Note: Create the pages and select Portfolio Template to display Portfolio pages.', 'snowfall' ); ?></p>
      <?php
   }
                     ...
                     <div class="portfolio-images-wrapper">
                        ...
                        <div class="port-img">
                           <?php if( has_post_thumbnail() ) {
                              the_post_thumbnail('snowfall-portfolio-image');
                        ...
                        <div class="portfolio-hover">
                           ...
                           <div class="port-title-wrapper">
                              ...
                              <div class="port-desc"> <?php echo snowfall_excerpt( 16 ); ?> </div>
                           </div>
                        </div>
                     </div>
                  <?php endwhile; ?>
 ...
 */
class snowfall_featured_posts_widget extends WP_Widget {

   function __construct() {
      $widget_ops = array( 'classname' => 'widget_featured_posts_block', 'description' => __( 'Display latest posts or posts of specific category', 'snowfall') );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::__construct( false,$name= __( 'TG: Featured Posts', 'snowfall' ),$widget_ops);
   }
   ...
   function form( $instance ) {
      ...
      <p><?php _e( 'Note: Enter the Featured Post Section ID and use same for Menu item. Only used for One Page Menu.', 'snowfall' ); ?></p>
       <p>
         <label for="<?php echo $this->get_field_id( 'featured_menu_id' ); ?>"><?php _e( 'Featured Post Section ID:', 'snowfall' ); ?></label>
      ...
      <p>
         <input type="radio" <?php checked( $type, 'latest' ) ?> id="<?php echo $this->get_field_id( 'type' ); ?>" name="<?php echo $this->get_field_name( 'type' ); ?>" value="latest"/><?php _e( 'Show latest Posts', 'snowfall' );?><br />
         <input type="radio" <?php checked( $type,'category' ) ?> id="<?php echo $this->get_field_id( 'type' ); ?>" name="<?php echo $this->get_field_name( 'type' ); ?>" value="category"/><?php _e( 'Show posts from a category', 'snowfall' );?><br />
      </p>

      <p>
         <label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php _e( 'Select category', 'snowfall' ); ?>:</label>
               ...
               <div class="tg-column-wrapper clearfix">
                  ...
                  while( $get_featured_posts->have_posts() ):$get_featured_posts->the_post(); ?>
                     ...
                     <div class="blog-block">
                        ...
                        <?php if( has_post_thumbnail() ) { ?>
                           <div class="blog-img">
                              <?php the_post_thumbnail('snowfall-featured-image'); ?>
                           </div>
                         <?php } ?>
                        ...
                        <div class="blog-content-wrapper">
                           ...
                           <div class="posted-date">
                              ...
                              <span>
                                 ...
                                 printf( __( '<span><a href="%1$s" title="%2$s" rel="bookmark"></i> %3$s</a></span>', 'snowfall' ),
                           ...
                           <a class="blog-readmore" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"> <?php echo __( 'Read more' , 'snowfall' ) ?> <i class="fa fa-angle-double-right"> </i> </a>
                        </div>
 ...
 * Our Team section.
 */
class snowfall_our_team_widget extends WP_Widget {
   function __construct() {
      $widget_ops = array( 'classname' => 'widget_our_team_block', 'description' => __( 'Show your Team Members.', 'snowfall' ) );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::__construct( false, $name = __( 'TG: Our Team Widget', 'snowfall' ), $widget_ops, $control_ops);
   }
   ...
   function form( $instance ) {
      ...
      <p><?php _e( 'Note: Enter the Our Team Section ID and use same for Menu item. Only used for One Page Menu.', 'snowfall' ); ?></p>
      <p>
         <label for="<?php echo $this->get_field_id( 'team_menu_id' ); ?>"><?php _e( 'Our Team Section ID:', 'snowfall' ); ?></label>
      ...
      <p>
         <label for="<?php echo $this->get_field_id( 'background_image' ); ?>"> <?php _e( 'Background Image:', 'snowfall' ); ?> </label> <br />
      ...
      <p><?php _e( 'Note: Create the pages and select Our Team Template to display Our Team pages.', 'snowfall' ); ?></p>
   <?php }
                        ...
                        <div class="tg-column-3 tg-column-bottom-margin">
                           <div class="team-block">
                              ...
                              <div class="team-img-wrapper">
                                 ...
                                 <div class="team-img">
                                    <?php if( has_post_thumbnail() ) {
                                       the_post_thumbnail( 'snowfall-featured-abt' );
                              ...
                              <div class="team-desc-wrapper">
                                 <?php
                                 $output = '';
                                 $snowfall_designation = get_post_meta( $post->ID, 'snowfall_designation', true );
                                 if( !empty( $snowfall_designation ) ) {
                                    $snowfall_designation = isset( $snowfall_designation ) ? esc_attr( $snowfall_designation ) : '';
                                    $output .= '<h5 class="team-deg">' . esc_html( $snowfall_designation ) . '</h5>';
                                 }
 ...
 * Contact us section.
 */
class snowfall_contact_widget extends WP_Widget {
   function __construct() {
      $widget_ops = array( 'classname' => 'widget_contact_block', 'description' => __( 'Show your Contact page.', 'snowfall' ) );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::__construct( false, $name = __( 'TG: Contact Us Widget', 'snowfall' ), $widget_ops, $control_ops);
   }
   ...
   function form( $instance ) {
      ...
      ?>
      <p><?php _e( 'Note: Enter the Contact Section ID and use same for Menu item. Only used for One Page Menu.', 'snowfall' ); ?></p>

      <p>
         <label for="<?php echo $this->get_field_id( 'contact_menu_id' ); ?>"><?php _e( 'Contact Section ID:', 'snowfall' ); ?></label>
      ...
      <p><?php _e( 'Select a Contact page.', 'snowfall' ) ?></p>
      <label for="<?php echo $this->get_field_id( 'page_id' ); ?>"><?php _e( 'Page', 'snowfall' ); ?>:</label>
      <?php wp_dropdown_pages( array( 'show_option_none' =>' ','name' => $this->get_field_name( 'page_id' ), 'selected' => $instance[ 'page_id' ] ) ); ?>

      <p><?php _e( 'Use Contact Form Plugin and enter the shortcode here:', 'snowfall' ) ?></p>
      <p>
         <label for="<?php echo $this->get_field_id( 'shortcode' ); ?>"><?php _e( 'Shortcode', 'snowfall' ); ?></label>
