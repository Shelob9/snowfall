...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
   ...
   <div class="entry-content">
      ...
      global $more;
      $more = 0;
      if( get_theme_mod( 'snowfall_content_show', 'show_full_post_content' ) == 'show_excerpt' ) {
         the_excerpt(); ?>
         <div class="entry-btn">
            <a class="btn" title="<?php the_title(); ?>" href="<?php the_permalink(); ?>"><?php _e( 'Read more', 'snowfall' ); ?>
            </a>
         </div>
      <?php }
      else {
         the_content( '<span>'. __( 'Read more', 'snowfall' ) .'</span>' );
      } ?>
   </div>
